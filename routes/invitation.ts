...
import { respondToInvitation } from '../controllers/invitation/respondToInvitation.ts';
...
router.put('/respond', auth, respondToInvitation); //{eventId: string, response: 'ACCEPTED' | 'REFUSED'}
